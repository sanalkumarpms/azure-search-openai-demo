...
import { chatApi, RetrievalMode, ChatAppResponse, logChatApi, ChatAppResponseOrError, ChatAppRequest, ResponseMessage, ChatHistory, logFeedback } from "../../api";
    ...
    const makeApiRequest = async (question: string) => {
        ...
        try {
            ...
            if (shouldStream) {
                ...
                userFeedback = 0;
                logChat(question, parsedResponse, responseTime, "N");
            } else {
                ...
                if (parsedResponse) {
                    // Log error
                    userFeedback = 0;
                    logChat(question, parsedResponse as ChatAppResponse, responseTime, "Y");
                }
            }
        } catch (e) {
            setError(e);
